              ...
              @if (Route::has('login'))
                @auth
                  @if (Auth::user()->level == 'admin')
                    <li class="scroll-to-section"><div class="border-first-button"><a href="{{ url('admin/dashboard') }}">Dashboard</a></div></li>   
                  @elseif (Auth::user()->level == 'tutor')
                    <li class="scroll-to-section"><div class="border-first-button"><a href="{{ url('tutor/dashboard') }}">Dashboard</a></div></li>   
                  @elseif (Auth::user()->level == 'peserta')
                    <li class="scroll-to-section"><div class="border-first-button"><a href="{{ url('peserta/dashboard') }}">Dashboard</a></div></li>      
                  @endif
                @else
                  <li class="scroll-to-section"><div class="border-first-button"><a href="{{ route('login') }}">Log in</a></div></li> 
                @endauth
              @endif
            </ul>        
