    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            @else
                ...
                <li class="menu">
                    <a href="#pengaturan" data-toggle="collapse" aria-expanded="{{ Request::segment(2) == 'profil' || 'akun' ? 'true' : 'false' }}" class="dropdown-toggle">
                        <div class="">
                    ...
                    <ul class="{{ Request::segment(2) == 'profil' || 'akun' ? 'toggle' : 'collapse' }} submenu list-unstyled" id="pengaturan" data-parent="#accordionExample">
