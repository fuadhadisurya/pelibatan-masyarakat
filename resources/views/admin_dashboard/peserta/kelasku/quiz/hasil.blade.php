        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-12 layout-spacing">
            ...
            <div class="widget-content-area br-4">
                        ...
                        <table class="table table-bordered mb-4">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><strong>{{ $jawabanBenar }}</strong></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><strong>{{ $skorTotal }}%</strong></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div class="d-flex justify-content-between">
                    <a href="{{ route('peserta.kelasku.quiz.index', [$kelas->id]) }}" class="btn btn-sm btn-secondary">Kembali</a>
                </div>
            </div>
        </div>
